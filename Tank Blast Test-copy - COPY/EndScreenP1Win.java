...
public class EndScreenP1Win extends SimulationWorld
{
    ...
    private void prepare()
    {
        ...
        BeamTankP1 beamTankP1 = new BeamTankP1(Player.INITIAL_HEALTH);
        addObject(beamTankP1,506,516);
        beamTankP1.setLocation(506,520);
        BuffTankP1 buffTankP1 = new BuffTankP1(Player.INITIAL_HEALTH);
        addObject(buffTankP1,806,525);
        buffTankP1.setLocation(804,516);
        DoubleCannonTankP1 doubleCannonTankP1 = new DoubleCannonTankP1(Player.INITIAL_HEALTH);
        ...
        DoubleCannonTankP1 doubleCannonTankP12 = new DoubleCannonTankP1(Player.INITIAL_HEALTH);
        ...
        BeamTankP1 beamTankP12 = new BeamTankP1(Player.INITIAL_HEALTH);
        ...
        BuffTankP1 buffTankP12 = new BuffTankP1(Player.INITIAL_HEALTH);
